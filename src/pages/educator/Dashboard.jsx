...
import { dummyDashboardData } from "../../assets/dummyDB";
import Loading from "../../components/student/Loading";
import { assets } from "../../assets/assets";

const Dashboard = () => {
  const { currency } = useCourse();
  ...
  return dashboardData ? (
    <div className="min-h-screen flex flex-col items-start justify-baseline gap-8 md:p-8 md:pb-0 pt-8 pb-0">
      <div className="space-y-5">
        <div className="flex flex-wrap gap-5 items-center">
          <div className="flex items-center gap-3 shadow-custom-card border border-blue-600 p-4 w-60 rounded-md">
